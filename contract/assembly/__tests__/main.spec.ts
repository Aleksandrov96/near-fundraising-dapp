...
describe('contract methods', () => {
  ...
  it('gets a list of projects', () => {
    const projectsArr = new Array<number>(20)
      .fill(0)
      .map<Project>((_, i) => Project.create('project', 'url', 'description', `wallet.testnet${i.toString()}`));

    expect(get(20, 10)).toStrictEqual(projectsArr.slice(20));
    expect(get(5, 10)).toStrictEqual(projectsArr.slice(20));
  });
